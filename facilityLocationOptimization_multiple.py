...
def solve_multiple_enumerative():
	...
	for f in objective_functions:
		all_yvals[f] = tuple(yvals[f]) # so they are hashable later for grouping plots
...
def plotMultiplCDFs(want_to_plot,quantityLabel):
	...
	plt.title(f"{quantityLabel}, Empirical CDF (nIndividuals={nIndiv},nFacilities={nSelectedFac}/{nFac},nTrials={nTrials})")
